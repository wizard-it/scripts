...
param(
    ...
    [string]
    $ChocolateyDownloadUrl = "http://nexus.shuvoe.rg-rus.ru/repository/chocolatey/chocolatey/0.11.3",
...
function Install-7zip {
    ...
    if (-not (Test-Path ($Path))) {
        ...
        Request-File -Url 'http://nexus.shuvoe.rg-rus.ru/repository/helpers/utils/7z/7za.exe' -File $Path -ProxyConfiguration $ProxyConfiguration
